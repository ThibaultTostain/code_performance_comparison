...
echo "4. Install polars matplotlib pyarrow and scipy in the virtual environment"
echo ""
...
# Step 4: Activate the environment and pip install
echo "Installing polars matplotlib pyarrow and scipy in the virtual environment..."
source "$VENV_NAME/bin/activate"
if pip install polars matplotlib pyarrow scipy; then
    echo ". installed successfully."
    echo "You can activate the environment with: source $VENV_NAME/bin/activate"
else
    echo "Error: Failed to install polars matplotlib pyarrow or scipy."
    exit 1
fi
